<?php
class Smartaddons_Megamenu_Block_Adminhtml_Widget_AddField extends Mage_Core_Block_Template
{
	protected	$_p ;
	protected	$_b ;
    ...
    public function _addField($parameter,$fieldset)
    {
        ...
        if ($helper = $parameter->getHelperBlock()) {
			Mage::register('megamenu_adminhtml_widget_chooser',1);	// cho phep block Smartaddons_Megamenu_Block_Adminhtml_Widget_Chooser check widget available for megamenu
