...
class Omniesolutions_Career_Block_Adminhtml_Career_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("career_data") && Mage::registry("career_data")->getId() ){
				    ...
				    return Mage::helper("career")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("career_data")->getId()));
